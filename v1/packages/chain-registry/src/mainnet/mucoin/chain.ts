...
const info: Chain = {
  ...
  codebase: {
    ...
    compatible_versions: ['rewards-v0.7.0'],
    consensus: {
      type: 'cometbft',
      version: 'v0.38.21'
    },
  ...
  apis: {
    rpc: [{
        ...
        address: 'https://rpc.nodesafe-app.xyz/mucoin/',
        provider: 'NodeSafe'
      }],
    rest: [{
        ...
        address: 'https://api.nodesafe-app.xyz/mucoin',
        provider: 'NodeSafe'
      }],
    grpc: [{
        address: 'grpc-mucoin.nodesafe-app.xyz:443',
        provider: 'NodeSafe'
      }]
  },
  explorers: [{
      kind: 'NodeSafe',
      url: 'https://explorer.nodesafe-app.xyz/mucoin/staking'
    }]
};
export default info;