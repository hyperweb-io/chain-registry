...
const info: Chain = {
  ...
  explorers: [
    ...
    },
    {
      ...
      tx_page: 'https://explorer.crouton.digital/mainnets/akash/transactions/${txHash}',
      account_page: 'https://explorer.crouton.digital/mainnets/akash/account/${accountAddress}'
    }
  ],
  images: [{
      png: 'https://raw.githubusercontent.com/cosmos/chain-registry/master/akash/images/akt.png',
