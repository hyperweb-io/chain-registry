...
const info: Chain = {
  ...
  codebase: {
    git_repo: 'https://github.com/solva-solutions/neutron',
    ...
    genesis: {
      genesis_url: 'https://raw.githubusercontent.com/solva-solutions/neutron-mainnet-assets/main/neutron-1-genesis.json'
    },
    sdk: {
      type: 'cosmos',
