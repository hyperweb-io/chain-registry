...
const info: AssetList = {
  ...
  assets: [
    ...
    },
    {
      ...
      extended_description: 'PHMN is the governance token of POSTHUMAN DAO. The new PHMN token was created on Cosmos Hub through TokenFactory after the 2026 migration from the legacy Juno CW20 token.',
      denom_units: [{
    ...
    },
    {
      ...
      extended_description: 'RESP is the POSTHUMAN reputation token. This Cosmos Hub TokenFactory asset represents the migration of RESP from the legacy Juno token to Cosmos Hub under the new Reputation SubDAO.',
      denom_units: [{
    ...
    {
      description: 'International man of mystery and President of the Interchain Cinnamina Foundation. Everyone loves Cinnabuns!',
      denom_units: [{
          denom: 'factory/cosmos1czdq25vuxw64gcj3lwvl3z93l76d92y7nys9u2/cinn',
          exponent: 0
        }, {
          denom: 'cinn',
          exponent: 6
      ...
      type_asset: 'sdk.coin',
      base: 'factory/cosmos1czdq25vuxw64gcj3lwvl3z93l76d92y7nys9u2/cinn',
      name: 'Mr. Cinnamon',
      display: 'cinn',
      symbol: 'CINN',
      images: [{
          png: 'https://raw.githubusercontent.com/cosmos/chain-registry/master/cosmoshub/images/cinn.png'
        }],
      logo_URIs: {
        png: 'https://raw.githubusercontent.com/cosmos/chain-registry/master/cosmoshub/images/cinn.png'
      }
