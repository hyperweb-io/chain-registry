...
const info: Chain = {
  ...
  explorers: [
    ...
    },
    {
      ...
      tx_page: 'https://moon-runners.net/oraichain/mainnet/finder?search=${txHash}',
      account_page: 'https://moon-runners.net/oraichain/mainnet/finder?search=${accountAddress}'
    }
  ],
  images: [{
      png: 'https://raw.githubusercontent.com/cosmos/chain-registry/master/oraichain/images/orai.png',
