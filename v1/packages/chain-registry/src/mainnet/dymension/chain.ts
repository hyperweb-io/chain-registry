...
const info: Chain = {
  ...
  explorers: [
    ...
    },
    {
      ...
      tx_page: 'https://moon-runners.net/dymension/mainnet/finder?search=${txHash}',
      account_page: 'https://moon-runners.net/dymension/mainnet/finder?search=${accountAddress}'
    }
  ],
  snapshots: [{
