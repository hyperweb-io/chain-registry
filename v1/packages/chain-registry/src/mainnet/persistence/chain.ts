...
const info: Chain = {
  ...
  explorers: [
    ...
    },
    {
      ...
      tx_page: 'https://moon-runners.net/persistence/mainnet/finder?search=${txHash}',
      account_page: 'https://moon-runners.net/persistence/mainnet/finder?search=${accountAddress}'
    }
  ],
  images: [{
      png: 'https://raw.githubusercontent.com/cosmos/chain-registry/master/persistence/images/xprt.png',
  ...
  snapshots: [
    ...
    },
    {
      ...
      latest_url: 'https://api.kleomedes.network/api/v2/snapshots/persistence/latest',
      type: 'pruned',
      compression: 'zstd',
      provider: 'Kleomedes'
    }
