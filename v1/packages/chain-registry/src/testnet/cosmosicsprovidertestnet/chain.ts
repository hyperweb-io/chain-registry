...
const info: Chain = {
  ...
  codebase: {
    ...
    recommended_version: 'v27.2.0-rc0',
    compatible_versions: ['v27.2.0-rc0'],
    consensus: {
      type: 'cometbft',
      version: 'v0.38.21'
    },
    binaries: {
      "darwin/amd64": 'https://github.com/cosmos/gaia/releases/download/v27.2.0-rc0/gaiad-v27.2.0-rc0-darwin-amd64',
      "darwin/arm64": 'https://github.com/cosmos/gaia/releases/download/v27.2.0-rc0/gaiad-v27.2.0-rc0-darwin-arm64',
      "linux/amd64": 'https://github.com/cosmos/gaia/releases/download/v27.2.0-rc0/gaiad-v27.2.0-rc0-linux-amd64',
      "linux/arm64": 'https://github.com/cosmos/gaia/releases/download/v27.2.0-rc0/gaiad-v27.2.0-rc0-linux-arm64'
    },
    genesis: {
