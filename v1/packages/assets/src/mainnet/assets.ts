...
import _nvnmchain from './nvnmchain';
...
import _ritbit from './ritbit';
import _rizon from './rizon';
import _safrochain from './safrochain';
...
import _wolochain from './wolochain';
...
const assets: AssetList[] = [_ethereum,_namada,_penumbra,_solana,_aaronetwork,_acrechain,_agoric,_aioz,_akash,_allora,_amitis,_andromeda,_archway,_arkeo,_arkh,_assetmantle,_atomone,_aura,_axelar,_babylon,_bandchain,_beezee,_bitbadges,_bitcanna,_bitsong,_bitway,_bluzelle,_bostrom,_canto,_carbon,_celestia,_chain4energy,_cheqd,_chihuahua,_cifer,_comdex,_composable,_conscious,_coreum,_cosmoshub,_crescent,_cronos,_cryptoorgchain,_decentr,_desmos,_divine,_doravota,_dungeon,_dydx,_dymension,_dyson,_echelon,_emoney,_empowerchain,_epix,_fandomchain,_fetchhub,_firmachain,_furya,_galaxy,_gateway,_genesisl1,_gitopia,_gnodi,_gonka,_gravitybridge,_haqq,_hazinachain,_hippoprotocol,_humans,_hyve,_impacthub,_imversed,_initia,_injective,_int3face,_intento,_irisnet,_jackal,_joltify,_juno,_kava,_kichain,_kimanetwork,_konstellation,_kopi,_kujira,_kyve,_lava,_likecoin,_lombardledger,_lorenzo,_lumen,_lumera,_lumnetwork,_mande,_manifest,_mantrachain,_medasdigital,_meme,_migaloo,_mirage,_mtgbp,_mucoin,_neutaro,_neutron,_nibiru,_nim,_noble,_nolus,_nomic,_nvnmchain,_nyx,_odin,_okexchain,_optio,_oraichain,_osmosis,_panacea,_passage,_paxi,_persistence,_planq,_point,_provenance,_pundix,_pylons,_qfs,_qie,_quasar,_quicksilver,_qwoyn,_realio,_rebus,_regen,_ritbit,_rizon,_safrochain,_saga,_scorum,_secretnetwork,_seda,_sei,_self,_sentinel,_sge,_shareledger,_shentu,_shido,_sidechain,_sifchain,_sommelier,_source,_sovr,_stafihub,_stratos,_stride,_sunrise,_symphony,_synternet,_tail,_taketitan,_teritori,_terra,_terra2,_thejaynetwork,_titan,_turkchain,_unification,_uptick,_wolochain,_xion,_xpla,_xrplevm,_zenrock,_zigchain];
