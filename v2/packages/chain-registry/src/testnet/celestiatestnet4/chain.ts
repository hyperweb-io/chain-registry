...
const info: Chain = {
  ...
  explorers: [
    ...
    },
    {
      ...
      txPage: 'https://explorer.crouton.digital/testnets/celestia/transactions/${txHash}',
      accountPage: 'https://explorer.crouton.digital/testnets/celestia/account/${accountAddress}'
    }
  ]
};
export default info;