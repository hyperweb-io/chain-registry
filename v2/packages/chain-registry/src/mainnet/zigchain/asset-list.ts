...
const info: AssetList = {
  ...
  assets: [
    ...
    },
    {
      ...
      denomUnits: [{
          denom: 'ibc/6C6F5A015608CF3951DFE6A117390210AB825BF0CC1AD33B2B100B05529A9B6B',
          exponent: 0
        }, {
          denom: 'usdc',
          exponent: 6
        }],
      base: 'ibc/6C6F5A015608CF3951DFE6A117390210AB825BF0CC1AD33B2B100B05529A9B6B',
      name: 'Injective USDC',
      display: 'usdc',
      symbol: 'USDC.inj',
      logoURIs: {
      ...
      traces: [{
          ...
          chain: {
            ...
            path: 'transfer/channel-12/erc20:0xa00C59fF5a080D2b954d0c75e46E22a0c371235a'
          }
        }],
      typeAsset: 'ics20',
      images: [{
